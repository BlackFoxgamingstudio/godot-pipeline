#!/usr/bin/env python3
"""
CLI entrypoint for sovereign-godot-pipeline
"""
import sys
import json
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="Automated headless build, asset compression, and episodic chapter validation pipeline for Godot Engine 4.x projects. Compiles Linux, macOS, and WebGL builds automatically from CI/CD runners.")
